...
router.post("/", async (req, res) => {
    ...
    let { data } = await axios.get(`${process.env.apiEmployee}/api/notifications/app/slug/user?app_id=${app_id}&slug=${slug}&user_id=${user_id}&per_page=${per_page}&page=${page}`, config);
