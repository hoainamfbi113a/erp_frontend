...
export const NAME_BTN_CLASS = 'btnClass';
export const NAME_BTN_VALUE = 'btnValue';

export const NAME_OPTION_RADIO = 'radio_option';
export const NAME_VALUE_RADIO = 'radio_value';

export const NAME_OPTION_CHECKBOX = 'checkbox_option';
export const NAME_VALUE_CHECKBOX = 'checkbox_value';

export const NAME_OPTION_SELECT = 'select_option';
export const NAME_VALUE_SELECT = 'select_value';